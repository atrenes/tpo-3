...
public class ChoseCategoryTest {
  ...
  public void choseCategory() {
    ...
    driver.findElement(By.xpath("//div[@id=\'root\']/div/div[2]/main/div[2]/a[2]/div")).click();
    vars.put("url", js.executeScript("return window.location.href"));
    assertEquals(vars.get("url").toString(), "https://www.answers.com/science");
    driver.findElement(By.xpath("//div[@id=\'root\']/div/div/div/div[2]/a/img")).click();
    driver.findElement(By.xpath("//div[@id=\'root\']/div/div[2]/main/div[2]/a[3]/div[2]")).click();
    vars.put("url", js.executeScript("return window.location.href"));
    assertEquals(vars.get("url").toString(), "https://www.answers.com/history");
  }
}
